...
bind = "0.0.0.0:8443"
backlog = 2048
certfile = os.environ.get("GUNICORN_SSL_CRT", "/home/unicoremgr/certs/unicoremgr.crt")
keyfile = os.environ.get("GUNICORN_SSL_KEY", "/home/unicoremgr/certs/unicoremgr.key")
preload_app = True
...
pidfile = "/home/unicoremgr/gunicorn.pid"
umask = 0
user = 1000
group = 100
tmp_upload_dir = None
