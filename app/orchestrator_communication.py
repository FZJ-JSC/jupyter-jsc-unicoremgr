...
def set_hostname(app_logger, uuidcode, orchestrator_url, servername, value):
    app_logger.debug("uuidcode={} - Call Orchestrator to set hostname for servername {} (value: {})".format(uuidcode, servername, value))
